...
const jmeno = (prompt ("Zadej křestní jméno bez diaktritiky:"))
const prijmeni = (prompt ("Zadej příjmení bez diaktritiky:"))

const domena = "@fit.cvut.cz"
const email = prijmeni.trim().slice(0, 5) + jmeno.trim().slice(0, 3)

document.body.innerHTML =
`E-mail FIT ČVUT je: ${email.toLowerCase()}${domena}.`
